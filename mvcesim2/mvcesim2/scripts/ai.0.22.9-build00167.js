...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            ...
            _InternalMessageId[_InternalMessageId["NONUSRACT_Missing FieldSpecification"] = 23] = "NONUSRACT_Missing FieldSpecification";
        ...
        var Serializer = (function () {
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                for (var field in source.aiDataContract) {
                    ...
                    var is  = (typeof contract === "function") ? (contract() & FieldType. ) : (contract & FieldType. );
                    ...
                    if (is  && !isPresent && !isArray) {
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_Missing FieldSpecification, "Missing   field specification. The field is   but not present on source", { field: field, name: name }));
                        continue;
                    }
                    if (isHidden) {
                        continue;
            ...
            (function (Common) {
                ...
                var Envelope = (function (_super) {
                    ...
                    function Envelope(data, name) {
                        ...
                        this.aiDataContract = {
                            time: ApplicationInsights.FieldType. ,
                            iKey: ApplicationInsights.FieldType. ,
                            name: ApplicationInsights.FieldType. ,
                            sampleRate: function () {
                                return (_this.sampleRate == 100) ? ApplicationInsights.FieldType.Hidden : ApplicationInsights.FieldType. ;
                            },
                            tags: ApplicationInsights.FieldType. ,
                            data: ApplicationInsights.FieldType. 
                        };
                    }
                    return Envelope;
        ...
        (function (Telemetry) {
            ...
            var Trace = (function (_super) {
                ...
                function Trace(message, properties) {
                    _super.call(this);
                    this.aiDataContract = {
                        ver: ApplicationInsights.FieldType. ,
                        message: ApplicationInsights.FieldType. ,
        ...
        (function (Telemetry) {
            ...
            var Exception = (function (_super) {
                ...
                function Exception(exception, handledAt, properties, measurements) {
                    ...
                    this.aiDataContract = {
                        ver: ApplicationInsights.FieldType. ,
                        handledAt: ApplicationInsights.FieldType. ,
                        exceptions: ApplicationInsights.FieldType. ,
                        severityLevel: ApplicationInsights.FieldType.Default,
                        properties: ApplicationInsights.FieldType.Default,
                        measurements: ApplicationInsights.FieldType.Default
                    };
            ...
            var _ExceptionDetails = (function (_super) {
                ...
                function _ExceptionDetails(exception) {
                    ...
                    this.aiDataContract = {
                        ...
                        typeName: ApplicationInsights.FieldType. ,
                        message: ApplicationInsights.FieldType. ,
            ...
            var _StackFrame = (function (_super) {
                ...
                function _StackFrame(frame, level) {
                    ...
                    this.sizeInBytes = 0;
                    this.aiDataContract = {
                        level: ApplicationInsights.FieldType. ,
                        method: ApplicationInsights.FieldType. ,
                ...
                var DataPoint = (function (_super) {
                    ...
                    function DataPoint() {
                        ...
                        this.aiDataContract = {
                            ...
                            value: ApplicationInsights.FieldType. ,
        ...
        (function (Telemetry) {
            ...
            var Metric = (function (_super) {
                ...
                function Metric(name, value, count, min, max, properties) {
                    ...
                    this.aiDataContract = {
                        ver: ApplicationInsights.FieldType. ,
                        metrics: ApplicationInsights.FieldType. ,
                        properties: ApplicationInsights.FieldType.Default
                    };
            ...
            (function (Common) {
                ...
                var Data = (function (_super) {
                    ...
                    function Data(type, data) {
                        _super.call(this);
                        this.aiDataContract = {
                            baseType: ApplicationInsights.FieldType. ,
                            baseData: ApplicationInsights.FieldType. 
                        };
                        this.baseType = type;
                        this.baseData = data;
                    }
        ...
        (function (Telemetry) {
            ...
            var RemoteDependencyData = (function (_super) {
                ...
                function RemoteDependencyData(id, name, commandName, value, success, resultCode) {
                    _super.call(this);
                    this.aiDataContract = {
                        id: ApplicationInsights.FieldType. ,
                        ver: ApplicationInsights.FieldType. ,
                        name: ApplicationInsights.FieldType.Default,
                        kind: ApplicationInsights.FieldType. ,
